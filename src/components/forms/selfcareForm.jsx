...
//       <div className="bg-gradient-to-br from-white to-pink-50/50 backdrop-blur-sm rounded-3xl shadow-2xl p-4 sm:p-6 border border-white/20">
//         {/* Header */}
...
//                 <span>{showAdvanced ? 'Hide' : 'Show'} All</span>
//               </button>
//             </div>
...
//                 className="text-charcoal-grey w-full px-4 py-3 bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-200 rounded-xl focus:border-blue-400 focus:ring-4 focus:ring-blue-100 transition-all duration-200 text-sm"
...
//                   className="text-charcoal-grey w-full px-4 py-3 bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-yellow-200 rounded-xl focus:border-yellow-400 focus:ring-4 focus:ring-yellow-100 transition-all duration-200 text-sm"
...
//                         toast(`Set to ${duration.fullLabel}`, {
//                           icon: duration.icon,
//                           duration: 1500,
//                         });
//                       }}
//                       className="p-2 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg hover:from-gray-100 hover:to-gray-200 transition-all text-center text-xs sm:text-sm"
//                     >
//                       <span className="hidden sm:inline">{duration.fullLabel}</span>
//                       <span className="sm:hidden">{duration.label}m</span>
//                     </button>
//                   ))}
//                 </div>
//               </div>
...
//               rows="2"
//               className="w-full px-4 py-3 bg-gradient-to-br from-gray-50 to-purple-50 border-2 border-gray-200 rounded-xl focus:border-purple-400 focus:ring-4 focus:ring-purple-100 transition-all duration-200 resize-none text-sm"
...
//                   <span className="text-sm sm:text-base">{editingRecord ? 'Update' : 'Record'} Self-Care</span>
...
//           {/* Quick Stats */}
//           <div className="grid grid-cols-3 gap-2 pt-3 sm:pt-4 border-t border-gray-200">
//             <div className="text-center p-2 sm:p-3 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl">
//               <div className="text-[10px] sm:text-sm text-gray-600">Duration</div>
//               <div className="text-sm sm:text-lg font-bold text-blue-600">{formData.duration || '0'} min</div>
//             </div>
//             <div className="text-center p-2 sm:p-3 bg-gradient-to-br from-pink-50 to-rose-50 rounded-xl">
//               <div className="text-[10px] sm:text-sm text-gray-600">Satisfaction</div>
//               <div className="text-sm sm:text-lg font-bold text-pink-600">{formData.satisfaction}/10</div>
//             </div>
//             <div className="text-center p-2 sm:p-3 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl">
//               <div className="text-[10px] sm:text-sm text-gray-600">Mood Δ</div>
