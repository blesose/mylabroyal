...
//         ovulationDate: ovulationDate.toISOString(),
//         fertileWindowStart: fertileWindowStart.toISOString(),
//         fertileWindowEnd: ovulationDate.toISOString(),
//         notes: formData.notes || '',
//       };
...
//             <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent break-words">
//               Ovulation Tracking
//             </h2>
//             <p className="text-gray-600 mt-2 text-sm sm:text-base flex items-center gap-2 flex-wrap">
//               <Target className="w-4 h-4 flex-shrink-0" />
//               <span>Track your fertile window and ovulation symptoms</span>
//             </p>
//           </div>
          
//           <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-pink-100 to-purple-100 flex-shrink-0">
//             <Egg className="w-4 h-4 text-pink-600" />
//             <span className="text-sm font-medium text-pink-700 whitespace-nowrap">Fertility Insights</span>
//           </div>
//         </div>

//         {/* Tabs - Fixed to be responsive */}
...
//               whileTap={{ scale: 0.95 }}
//               onClick={() => handleTabChange(tab)}
//               className={`flex-1 px-3 sm:px-4 py-3 text-xs sm:text-sm font-medium border-b-2 transition-all whitespace-nowrap ${
//                 activeTab === tab
//                   ? 'border-pink-500 text-pink-600'
//                   : 'border-transparent text-gray-500 hover:text-gray-700'
//               }`}
//             >
//               {tab === 'basics' && <span className="flex items-center justify-center gap-1 sm:gap-2"><Calendar className="w-3 h-3 sm:w-4 sm:h-4" /> <span>Basics</span></span>}
//               {tab === 'symptoms' && <span className="flex items-center justify-center gap-1 sm:gap-2"><Activity className="w-3 h-3 sm:w-4 sm:h-4" /> <span>Symptoms</span></span>}
//               {tab === 'results' && <span className="flex items-center justify-center gap-1 sm:gap-2"><Target className="w-3 h-3 sm:w-4 sm:h-4" /> <span>Results</span></span>}
//             </motion.button>
//           ))}
//         </div>
//       </motion.div>
...
//           {/* Results Tab - FIXED: Properly contained on all screens */}
//           {activeTab === 'results' && (
//             <motion.div
//               key="results"
//               initial={{ opacity: 0, x: -20 }}
...
//                     {/* Fertile Window */}
//                     <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-xl sm:rounded-2xl p-4 border-2 border-pink-200 w-full">
//                       <div className="flex items-center gap-2 mb-2">
//                         <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-pink-500 flex-shrink-0" />
//                         <h4 className="font-semibold text-pink-700 text-sm sm:text-base">Fertile Window</h4>
//                       </div>
//                       <div className="text-base sm:text-lg md:text-xl font-bold text-pink-800 mb-1 break-words">
//                         {predictedDates.fertileWindow.start} - {predictedDates.fertileWindow.end}
//                       </div>
...
//                     {/* Ovulation Day */}
//                     <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl sm:rounded-2xl p-4 border-2 border-purple-200 w-full">
//                       <div className="flex items-center gap-2 mb-2">
//                         <Target className="w-4 h-4 sm:w-5 sm:h-5 text-purple-500 flex-shrink-0" />
//                         <h4 className="font-semibold text-purple-700 text-sm sm:text-base">Ovulation Day</h4>
//                       </div>
//                       <div className="text-base sm:text-lg md:text-xl font-bold text-purple-800 mb-1 break-words">
//                         {predictedDates.ovulationDay}
//                       </div>
...
//                     {/* Next Period */}
//                     <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl sm:rounded-2xl p-4 border-2 border-blue-200 w-full">
//                       <div className="flex items-center gap-2 mb-2">
//                         <Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-blue-500 flex-shrink-0" />
//                         <h4 className="font-semibold text-blue-700 text-sm sm:text-base">Next Period</h4>
//                       </div>
//                       <div className="text-base sm:text-lg md:text-xl font-bold text-blue-800 mb-1 break-words">
//                         {predictedDates.nextPeriod}
//                       </div>
...
//                   <CheckCircle className="w-2 h-2 sm:w-3 sm:h-3 text-blue-600" />
//                 </div>
//                 <span className="break-words">Ovulation typically occurs 12-16 days before your next period</span>
//               </li>
//               <li className="flex items-start gap-1.5 sm:gap-2">
//                 <div className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0 mt-0.5">
//                   <CheckCircle className="w-2 h-2 sm:w-3 sm:h-3 text-blue-600" />
//                 </div>
//                 <span className="break-words">Fertile window is usually 5 days before ovulation through ovulation day</span>
//               </li>
//               <li className="flex items-start gap-1.5 sm:gap-2">
//                 <div className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0 mt-0.5">
//                   <CheckCircle className="w-2 h-2 sm:w-3 sm:h-3 text-blue-600" />
//                 </div>
//                 <span className="break-words">Track symptoms like egg-white cervical mucus for better predictions</span>
//               </li>
//             </ul>
//           </div>
//         </div>
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6">
      ...
      >
        ...
        {/* Tabs - With invisible scrollbar */}
        <div className="flex border-b border-gray-200 overflow-x-auto scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          <style jsx>{`
