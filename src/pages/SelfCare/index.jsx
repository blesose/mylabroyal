...
import React, { useEffect, useState } from "react";
import SelfCareForm from "../../components/forms/selfcareForm";
import Education from "./Education";
...
const SelfCare = () => {
  ...
  const loadActivities = async () => {
    ...
    const loadingToast = toast.loading(
      <div className="flex items-center gap-3">
        ...
        <span className="font-medium">Loading self-care activities...</span>
      </div>,
      { 
        style: {
          ...
          (t) => (
            <div className={`bg-gradient-to-r from-blue-500 to-cyan-500 text-white p-4 rounded-xl shadow-2xl transform transition-all ${t.visible ? 'animate-slide-in' : 'animate-slide-out'}`}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-bold">No Activities Yet</div>
                  <div className="text-sm opacity-90">Add your first self-care activity!</div>
                </div>
              </div>
            </div>
          ),
          ...
          <div className={`bg-gradient-to-r from-red-500 to-pink-500 text-white p-4 rounded-xl shadow-2xl transform transition-all ${t.visible ? 'animate-slide-in' : 'animate-slide-out'}`}>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm opacity-90">Could not fetch self-care activities</div>
              </div>
            </div>
          </div>
        ),
  ...
  const handleAdd = async (formData) => {
    const loadingToast = toast.loading(
      <div className="flex items-center gap-3">
        <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
        <span className="font-medium">Adding self-care activity...</span>
      </div>,
      { 
        style: {
          background: 'linear-gradient(135deg, #ec4899 0%, #f43f5e 100%)',
          ...
          (t) => (
            <div className={`bg-gradient-to-r from-green-500 to-emerald-500 text-white p-4 rounded-xl shadow-2xl transform transition-all ${t.visible ? 'animate-slide-in' : 'animate-slide-out'}`}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-bold">Self-Care Added!</div>
                  <div className="text-sm opacity-90">Your activity has been recorded</div>
                </div>
              </div>
            </div>
          ),
        ...
        (t) => (
          <div className={`bg-gradient-to-r from-red-500 to-pink-500 text-white p-4 rounded-xl shadow-2xl transform transition-all ${t.visible ? 'animate-slide-in' : 'animate-slide-out'}`}>
            <div className="flex items-center gap-3">
              <AlertTriangle className="h-6 w-6" />
              <div>
                <div className="font-bold">Failed to Add</div>
                <div className="text-sm opacity-90">{error.message || "Error adding activity"}</div>
              </div>
            </div>
          </div>
        ),
  ...
  const handleUpdate = async (id, updatedData) => {
    const loadingToast = toast.loading(
      <div className="flex items-center gap-3">
        <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
        <span className="font-medium">Updating activity...</span>
      </div>,
      { 
        style: {
          background: 'linear-gradient(135deg, #ec4899 0%, #f43f5e 100%)',
          ...
          (t) => (
            <div className={`bg-gradient-to-r from-green-500 to-emerald-500 text-white p-4 rounded-xl shadow-2xl transform transition-all ${t.visible ? 'animate-slide-in' : 'animate-slide-out'}`}>
              <div className="flex items-center gap-3">
                <CheckCircle className="h-6 w-6" />
                <div>
                  <div className="font-bold">Activity Updated!</div>
          ...
          <div className={`bg-gradient-to-r from-red-500 to-pink-500 text-white p-4 rounded-xl shadow-2xl transform transition-all ${t.visible ? 'animate-slide-in' : 'animate-slide-out'}`}>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm opacity-90">{error.message || "Could not update activity"}</div>
              </div>
            </div>
          </div>
        ),
  ...
  const handleDeleteRecord = async (id) => {
    ...
    const deleteToast = toast.loading(
      <div className="flex items-center gap-3">
        <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
        <span className="font-medium">Deleting activity...</span>
      </div>,
      {
        style: {
            ...
            <div className={`bg-gradient-to-r from-green-500 to-emerald-500 text-white p-4 rounded-xl shadow-2xl transform transition-all ${t.visible ? 'animate-slide-in' : 'animate-slide-out'}`}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm opacity-90">Self-care activity removed successfully</div>
                </div>
              </div>
            </div>
          ),
        ...
        (t) => (
          <div className={`bg-gradient-to-r from-red-500 to-pink-500 text-white p-4 rounded-xl shadow-2xl transform transition-all ${t.visible ? 'animate-slide-in' : 'animate-slide-out'}`}>
            <div className="flex items-center gap-3">
              <AlertTriangle className="h-6 w-6" />
              <div>
                <div className="font-bold">Delete Failed</div>
                <div className="text-sm opacity-90">{error.message || "Could not delete activity"}</div>
              </div>
            </div>
          </div>
        ),
      ...
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-800">Delete Self-Care Activity</h3>
          </div>
          <p className="text-gray-600 mb-4">
            Are you sure you want to delete this activity from {formatDate(record?.createdAt)}?
                            ...
                            <div className="flex justify-between items-start mb-4">
                              ...
                              <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                ...
                                <motion.button
                                  whileHover={{ scale: 1.1 }}
                                  whileTap={{ scale: 0.9 }}
                                  onClick={() => setRecordToDelete(activity)}
                                  className="p-2 rounded-lg bg-red-500/20 hover:bg-red-500/30 transition-colors"
                                  title="Delete activity"
                                >
                                  <Trash2 className="w-4 h-4" />
