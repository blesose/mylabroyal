// // WhyUseMyLab.jsx - Premium Transformation
...
//   const stats = [
//     { icon: Award, value: "10,000+", label: "Royal Members", color: "text-pink-500" },
//     { icon: Clock, value: "24/7", label: "Premium Support", color: "text-blue-500" },
...
//   return (
//     <section className="relative py-24 bg-gradient-to-br from-gray-400 via-blue-500/100 to-pink-400/80 overflow-hidden">
//       {/* Animated Background */}
//       <div className="absolute inset-0 overflow-hidden">
//         <div className="absolute -top-40 -right-40 w-80 h-80 bg-pearl-400/20 rounded-full blur-3xl animate-float"></div>
...
//           <div className="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-sm border border-pink-300/30 rounded-2xl px-6 py-3 mb-6">
//             <Sparkles className="w-5 h-5 text-pink-300" />
//             <span className="font-bold text-pink-300 text-sm uppercase tracking-wider">
//               Premium Excellence
//             </span>
//           </div>
          
//           <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
//             Why Choose <span className="bg-gradient-to-r from-pink-300 to-blue-300 bg-clip-text text-transparent">MyLab Royal?</span>
//           </h2>
          
//           <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
//             Experience healthcare that treats you like royalty with features designed for 
//             <span className="font-semibold text-pink-300"> exceptional results </span>
//             and
//             <span className="font-semibold text-blue-300"> unparalleled comfort</span>
//           </p>
//         </div>
...
//                 <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-8 border-2 border-white/20 shadow-2xl hover:shadow-3xl transition-all duration-500 group-hover:scale-105 group-hover:border-pink-300/50 h-full">
//                   {/* Stat Badge */}
//                   <div className="absolute -top-3 -right-3 bg-gradient-to-r from-pink-500 to-blue-500 text-white px-3 py-1 rounded-2xl font-bold text-sm shadow-lg">
//                     {feature.stat}
//                   </div>
...
//                         <li key={benefitIndex} className="flex items-center justify-center space-x-2 text-sm text-pink-200 font-medium">
...
//                   {/* Hover Glow */}
//                   <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-pink-500/10 to-blue-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
//                 </div>
//               </div>
//             );
//           })}
...
//         {/* Stats Section */}
//         <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-12 border-2 border-pink-300/30 shadow-2xl mb-12">
...
//                     <div className="w-16 h-16 bg-pink-500/10 rounded-2xl flex items-center justify-center border-2 border-pink-300/30 group-hover:bg-pink-500/20 transition-all duration-300">
...
//           <div className="bg-gradient-to-r from-pink-500 to-blue-500 rounded-3xl p-8 border-2 border-white/20 shadow-2xl inline-block max-w-2xl">
      ...
      <div className="relative z-10 max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#0B132B] mb-6">
            Why Choose <span className="bg-gradient-to-r from-[#B1D182] to-[#688F48] bg-clip-text text-transparent">MyLab Royal?</span>
          </h2>
